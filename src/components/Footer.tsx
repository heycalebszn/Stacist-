...
export const Footer = () => {
    return(
        <footer className="flex flex-col text-white mt-[100px] bg-gradient from-[#010114] via-[#01011C] to-[#010114]">
            ...
            <div className="flex justify-between px-[50px] py-[16px]">
                <div className="flex flex-col">
                    ...
                    <div className="flex gap-2 items-center justify-center m-auto bg-gradient-to-r from-[#00BDFF] to-[#0037F8] rounded-[12px] px-[20px] py-[10px]">
            ...
            <BsArrowRight className="bg-transparent text-[15px] text-center"/>
                        ...
                        <div className="flex gap-2 items-center justify-center m-auto border border-[#00BDFF] rounded-[12px] px-[20px] py-[10px]">
