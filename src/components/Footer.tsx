        ...
        <footer className="flex flex-col text-white mt-[100px] bg-gradient-to-b from-[#010114] via-[#01011C] to-[#010114] w-full">
            ...
            <div className="md:flex md:flex-row justify-between px-[50px] py-[16px] flex-col">
                <div className="flex flex-col">
                    <h1 className="md:text-[2.5rem] font-bold w-[400px] text-[1.4rem]">Join the Thousands Already Benefiting</h1>
                    <div className="flex mt-[15px] items-center gap-4">
                    <div className="flex gap-2 items-center justify-center bg-gradient-to-r from-[#00BDFF] to-[#0037F8] rounded-[12px] px-[10px] py-[10px]">
            ...
            <BsArrowRight className="bg-transparent text-[15px] text-center"/>
                ...
                <div className="md:flex md:flex-row gap-[150px] flex-col md:mt-0 mt-[25px]">
                    ...
                    <div className="flex flex-col md:mt-0 mt-[15px]">
                        <h1>Product</h1>
